...
from diffusion.model.nets.PixelArt_blocks import t2i_modulate, CaptionEmbedder, WindowAttention, MultiHeadCrossAttention, T2IFinalLayer, TimestepEmbedder, SizeEmbedder
from diffusion.model.nets.PixelArt import PixelArt, get_2d_sincos_pos_embed
...
class PixelArtMSBlock(nn.Module):
    """
...
class PixelArtMS(PixelArt):
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            PixelArtMSBlock(hidden_size, num_heads, mlp_ratio=mlp_ratio, drop_path=drop_path[i],
    ...
    def forward(self, x, t, y, mask=None, data_info=None, **kwargs):
        ...
        # self.h, self.w = c_crop[0], c_crop[1]
...
#################################################################################
@MODELS.register_module()
def PixelArtMS_XL_2(**kwargs):
    return PixelArtMS(depth=28, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)


@MODELS.register_module()
def PixelArtMS_XL_4(**kwargs):
    return PixelArtMS(depth=28, hidden_size=1152, patch_size=4, num_heads=16, **kwargs)
