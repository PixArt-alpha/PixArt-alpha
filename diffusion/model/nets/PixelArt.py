...
from diffusion.model.nets.PixelArt_blocks import t2i_modulate, CaptionEmbedder, WindowAttention, MultiHeadCrossAttention, T2IFinalLayer, TimestepEmbedder, LabelEmbedder, FinalLayer
...
class PixelArt(nn.Module):
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            PixelArtBlock(hidden_size, num_heads, mlp_ratio=mlp_ratio, drop_path=drop_path[i],
...
#################################################################################
@MODELS.register_module()
def PixelArt_XL_2(**kwargs):
    return PixelArt(depth=28, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)


@MODELS.register_module()
def PixelArt_XL_4(**kwargs):
    return PixelArt(depth=28, hidden_size=1152, patch_size=4, num_heads=16, **kwargs)
