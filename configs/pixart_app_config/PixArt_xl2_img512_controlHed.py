...
model = 'PixArt_XL_2'
fp32_attention = True
load_from = 'output/t2iditMS-xl2-img512_singlebr_MJ1-13_ls1_vae_lr2e5/checkpoints/epoch_2_step_60000.pth' #model path
# load_from = None
...
num_workers=10
train_batch_size = 1 # 32  # max 96 for DiT-L/4 when grad_checkpoint
num_epochs = 1000 # 3
