...
model = 'PixArtMS_XL_2'
fp32_attention = True
#load_from = 'output_cv/t2iditMS-xl2-img1024_singlebr_MJ1-5_ls2_vae_lr2e5_continue2/checkpoints/epoch_1_step_22000.pth'
# load_from = '/home/x00819183/chenjunsong/output/Pixart/epoch_1_step_22000.pth'
